...
%Adicionar método de indexação
Processo pelo qual palavras de um texto são armazenadas em uma
estrutura de índice para viabilizar consultas por conteúdo
- Relembrar índices convencionais em bancos de dados
Para textos: arquivos, listas ou índices invertidos
• Mecanismos que utilizam palavras para indexar uma coleção de documentos, visando
facilitar e acelerar a tarefa de busca
• Dois elementos relevantes:
• Vocabulário – conjunto de termos que compõem uma coleção
• Ocorrências – presenças de termos do vocabulário em documentos, indicando os próprios
documentos (endereçamentos)
