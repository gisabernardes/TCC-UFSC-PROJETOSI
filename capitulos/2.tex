...
\begin{algorithm}[!htb]
    \SetAlgoLined
        ...
        \Repita{que identifique os K vizinhos mais próximos}{
...
Desta forma, vários tipos de sistemas QBH e suas derivações foram pesquisados:
\begin{itemize}
